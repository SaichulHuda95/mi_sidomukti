...
<main class="main">
    ...
    <div class="page-title dark-background" style="background-image: url(assets/img/app/bg_tittle.jpg);">
        <div class="container position-relative">
            <h1>Staff & Karyawan</h1>
            <p>Staff dan karyawan MI Nurul Ulum Sidomukti merupakan bagian penting dalam menunjang kelancaran operasional madrasah. Mereka bekerja dengan penuh dedikasi untuk menciptakan lingkungan belajar yang tertib, bersih, dan kondusif demi kenyamanan seluruh warga madrasah.</p>
            <nav class="breadcrumbs">
                <ol>
                    <li><a href="index">Beranda</a></li>
                    <li class="current">Staff & Karyawan</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="col-lg-3" data-aos="fade-up" data-aos-delay="300">
                    <div class="departments-nav">
                        ...
                        <ul class="nav nav-tabs flex-column">
                            ...
                            <li class="nav-item">
                                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#waka-kurikulum-tab">Wakil Kepala (Kurikulum)</button>
                            </li>
                            <li class="nav-item">
                                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#waka-kesiswaan-tab">Wakil Kepala (Kesiswaan)</button>
                            </li>
                            <li class="nav-item">
                                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#tu-tab">Tata Usaha</button>
                            </li>
                            <li class="nav-item">
                                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#perpustakaan-tab">Petugas Perpustakaan</button>
                            </li>
                            <li class="nav-item">
                                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#kebersihan-tab">Petugas Kebersihan</button>
                            </li>
                            <li class="nav-item">
                                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#keamanan-tab">Petugas Keamanan</button>
                            </li>
                        </ul>
                    </div>
                </div>
