                ...
                <div class="row align-items-center">
                    <div class="col-lg-7" data-aos="zoom-out" data-aos-delay="100">
                        <div class="hero-content">
                            <h1>Mendidik Generasi Islami & Berprestasi</h1>
                            <p>
                                MI Nurul Ulum Sidomukti berkomitmen membentuk siswa yang cerdas, berakhlak mulia, dan berwawasan luas melalui pendidikan yang unggul dan bernilai Islami.
                            </p>
                            <div class="cta-buttons">
                                <a href="profil" class="btn-primary">Tentang Kami</a>
                                <!-- <a href="#program-unggulan" class="btn-secondary">Lihat Program Unggulan</a> -->
                            </div>
                        </div>
                    </div>
    ...
    <section class="about section" id="tentang-kami">
        <div class="container">
            <div class="section-title text-center" data-aos="fade-up">
                <h2>Tentang MI Nurul Ulum Sidomukti</h2>
    ...
    <section id="testimonials" class="testimonials section">
        <div class="container">
            <div class="section-title text-center" data-aos="fade-up">
                ...
                <p>Testimoni dari wali murid tentang pengalaman anaknya bersekolah di MI Nurul Ulum</p>
            </div>
        </div>
        <div class="container">
